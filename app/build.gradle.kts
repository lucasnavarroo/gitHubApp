...
dependencies {
    ...
    implementation(project(":users:users_presentation"))
    implementation(project(":users:users_data"))
    ...
    debugImplementation("androidx.navigation:navigation-compose:2.7.6")
